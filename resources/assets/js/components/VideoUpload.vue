        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-info">
                    <div class="panel-heading"><i class="fa fa-hand-o-right" aria-hidden="true"></i>&nbsp; Upload</div>
                    ...
                    <div class="panel-body">
                        ...
                        <div id="video-form" v-if="uploading && !failed">
                            ...
                            <button class="btn btn-warning" type="submit" @click.prevent="update">Save changes</button>
